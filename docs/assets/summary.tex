...
% ===============================
% Hyperref (BEFORE polyglossia for Hebrew compatibility)
% ===============================
\usepackage{hyperref}
\hypersetup{
  colorlinks=true,
...
\begin{formulabox}
\textbf{מטריצה $2 \times 2$:}
\[ \det\begin{pmatrix} a & b \\ c & d \end{pmatrix} = ad - bc \]
\end{formulabox}

\subsection{תכונות הדטרמיננטה}
\begin{thmbox}
\textbf{תכונות פעולות שורה:}
\begin{itemize}
...
\begin{formulabox}
\textbf{נוסחת שינוי בסיס:}
\[ [v]_C = P_{C \leftarrow B} \cdot [v]_B \]
\end{formulabox}

\begin{thmbox}
\textbf{תכונות מטריצת מעבר:}
\begin{enumerate}
